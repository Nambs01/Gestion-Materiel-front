    ...
    <div class="column is-8-desktop is-10-tablet">
      <div class="card">
        <header class="card-header">
          <p class="card-header-title is-size-5">Nouveau materiel</p>
        </header>
        <div class="card-content">
          <form action="">
            ...
            <div class="field is-grouped is-grouped-right">
              ...
              <p class="control">
                <button class="button is-link" @click="validationAdd">Valider</button>
              </p>
            </div>
          </form>
        </div>
      ...
      <div class="modal-content is-flex is-justify-content-center">
        <div class="card success-content p-5">
          <div class="card-content">
            ...
            <p>L'ajout d'un nouveau matériel est effectuté avec succès.</p>
          </div>
        </div>
      </div>
    </div>
...
const validationAdd = async (e) => {
  ...
  if (num_materiel.value && design.value && etat.value && quantite.value) {
    try {
      await useMaterielStore().addMateriel(
        num_materiel.value,
        design.value,
        etat.value,
        quantite.value
